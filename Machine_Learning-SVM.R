...
movie <- read.csv("C:/Users/Amir/Google Drive/Movies/Project/Movie_classification.csv", header = TRUE)
...
df <- read.csv("C:/Users/Amir/Google Drive/Movies/Project/Movie_classification.csv", header = TRUE)
