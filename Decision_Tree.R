...
#import dataset
movie <- read.csv("C:/Users/Amir/Google Drive/Movies/Project/Presentation/Movie_regression.csv")
View(movie)
...
df <- read.csv("C:/Users/Amir/Google Drive/Movies/Project/Presentation/Movie_regression.csv")
View(df)
